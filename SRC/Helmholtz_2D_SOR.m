...
%   This code implements Successive Over Relaxation to the Gauss Saidel
%   solution in order to increase the performance of the project. 
...
%GAUSS SEIDEL ITERATIONS WITH SUCCESSIVE OVER RELAXATION 
